        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrowHeader = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MemberId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MemberSmallText = table.Column<string>(nullable: true),
                    MemberName = table.Column<string>(nullable: true),
                    MemberRole = table.Column<string>(nullable: true),
                    MemberImage = table.Column<string>(nullable: true),
                    MemberTwitter = table.Column<string>(nullable: true),
                    MemberFacebook = table.Column<string>(nullable: true),
                    MemberLinkedin = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SliderPosition = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
