...
namespace ExertSite.Controllers
{
    public class PortfoliosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PortfolioId,PortfolioImage,PortfolioName,PortfolioText")] Portfolio portfolio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PortfolioId,PortfolioImage,PortfolioName,PortfolioText")] Portfolio portfolio)
        {
